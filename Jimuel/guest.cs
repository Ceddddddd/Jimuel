    ...
    public partial class guest : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string query = "INSERT INTO Guests_table (GuestID, gender, Name) VALUES (@GuestID, @Gender, @Name)";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0) // Ensure a valid row index is clicked
            {
                ...
                textBox1.Text = row.Cells["GuestID"].Value.ToString();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            {
                // Define the SQL query with parameters
                string query = "UPDATE Guests_table SET gender = @Gender, Name = @Name WHERE GuestID = @GuestID";
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            {
                // Define the SQL query with parameters
                string query = "DELETE FROM Guests_table WHERE GuestID = @GuestID";
